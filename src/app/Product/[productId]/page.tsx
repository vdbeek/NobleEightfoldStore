    ...
    return (
        ...
        className='bg-white'>
                    ...
                    <div className='lg:max-w-lg lg:self-end'>
                        ...
                        <section className='mt-4'>
                            <div className='flex items-center'>
                                ...
                                <div className='ml-4 border-l text-orange-500 border-orange-300 pl-4'>
                                    {label}
                                </div>
                            </div>
                            ...
                            <div className='mt-6 flex items-center'>
                                ...
                                />
                                <p className='ml-2 text-small text-orange-600'>
                        ...
                        <div>
                            ...
                            <div className='mt-6 text-center'>
                                <div className='group inline-flex text-sm text-medium'>
                                    <Shield 
                                        aria-hidden="true" 
                                        className="mr-2 h-5 w-5 flex-shrink-0 text-orange-400"
                                    />
            ...
            <ProductReel 
                ...
                title={`Other ${label}`}
                subtitle={`Browse other ${label} like '${product.name}'`}
            />
        </MaxWidthWrapper>
    )
}
