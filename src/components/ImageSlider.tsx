...
const ImageSlider = ({urls}: ImageSliderProps) => {
    ...
    const activeStyles =
        "active:scale-[0.97] grid opacity-100 hover:scale-105 absolute top-1/2 -translate-y-1/2 aspect-square h-8 w-8 z-50 place-items-center rounded-full border-2 bg-orange-400 border-orange-500"
    const inactiveStyles = "hidden text-gray-400"

    return (
        <div className='group relative bg-orange-400 aspect-square overflow-hidden rounded-xl'>
