...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webhookMW, payload, cartRouter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webhookMW = body_parser_1.default.json({
                    verify: function (req, _, buffer) {
                        req.rawBody = buffer;
                    }
                });
                app.post("/api/webhooks/stripe", webhookMW, Webhooks_1.stripeWebhookHandler);
            ...
            case 1:
                ...
                cartRouter.get("/", function (req, res) {
                    ...
                    var parseUrl = (0, url_1.parse)(req.url, true);
